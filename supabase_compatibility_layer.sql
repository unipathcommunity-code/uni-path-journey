...
DROP VIEW IF EXISTS nova.organizations CASCADE;
DROP TABLE IF EXISTS nova.organizations CASCADE;
...
DROP VIEW IF EXISTS nova.leads CASCADE;
DROP TABLE IF EXISTS nova.leads CASCADE;
CREATE OR REPLACE VIEW nova.leads AS SELECT * FROM public.leads;

DROP VIEW IF EXISTS nova.payments CASCADE;
DROP TABLE IF EXISTS nova.payments CASCADE;
CREATE OR REPLACE VIEW nova.payments AS SELECT * FROM public.payments;

DROP VIEW IF EXISTS nova.lessons CASCADE;
DROP TABLE IF EXISTS nova.lessons CASCADE;
CREATE OR REPLACE VIEW nova.lessons AS SELECT * FROM public.lessons;

DROP VIEW IF EXISTS nova.attendance CASCADE;
DROP TABLE IF EXISTS nova.attendance CASCADE;
CREATE OR REPLACE VIEW nova.attendance AS SELECT * FROM public.attendance;

DROP VIEW IF EXISTS nova.profiles CASCADE;
DROP TABLE IF EXISTS nova.profiles CASCADE;
...
DROP VIEW IF EXISTS nova.user_roles CASCADE;
DROP TABLE IF EXISTS nova.user_roles CASCADE;
...
DROP VIEW IF EXISTS tour.profiles CASCADE;
DROP TABLE IF EXISTS tour.profiles CASCADE;
...
DROP VIEW IF EXISTS tour.user_roles CASCADE;
DROP TABLE IF EXISTS tour.user_roles CASCADE;
