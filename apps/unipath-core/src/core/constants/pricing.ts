...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    descRu: 'Для небольших агентств, которые только начинают',
    featuresUz: [
  ...
  },
  {
    ...
    popular: true,
    descUz: 'O\'sib borayotgan agentliklar uchun — ko\'p filial va katta jamoa',
    descEn: 'For growing agencies — multiple branches and a larger team',
    descRu: 'Для растущих агентств — несколько филиалов и большая команда',
    featuresUz: [
      '5 tagacha filial, 25 tagacha xodim',
      'Buxgalteriya moduli — daromad/xarajat, P&L hisobot',
      'Universitet va grant bazasi, viza kuzatuvi',
      'Agent komissiyasi va sub-agent hisoboti',
    ...
    featuresEn: [
      ...
      'University and grant database, visa tracking',
      'Agent commission and sub-agent reporting',
    ...
    featuresRu: [
      ...
      'База университетов и грантов, отслеживание виз',
      'Комиссии агентов и отчётность по суб-агентам',
