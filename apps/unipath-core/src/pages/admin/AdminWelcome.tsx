...
const STEPS = [
  {
    ...
    descUz: "Agentligingiz muvaffaqiyatli ro'yxatdan o'tdi va tizim ishga tushdi. Endi bir necha qadamda platformangizni sozlaylik.",
    descRu: "Ваше агентство зарегистрировано и система запущена. Настроим платформу за несколько шагов.",
  ...
  },
  {
    ...
    descUz: "Admin Sozlamalar sahifasida logotip, rang sxemasi va agentlik ma'lumotlaringizni sozlang. Mijozlaringiz sizning brendingizni ko'radi.",
    descRu: "В настройках установите логотип, цветовую схему и данные агентства. Клиенты увидят ваш бренд.",
  ...
  },
  {
    ...
    descRu: "Система управления агентством полностью готова. Перейдите на главную страницу и начните!",
